...
const PortfolioPartHome = ({ projects }) => {
    return (
        <React.Fragment>
...
PortfolioPartHome.propTypes = propTypes;
PortfolioPartHome.defaultProps = defaultProps;

export default PortfolioPartHome